...
--[[
	Labels:
		- map (brushes, skybox and displacements)
		- models
		- decals
		- * [All]
...
function Data:Create(ply, materialInfo, decalInfo, blockCleanup)
	local data = {
		...
		entIndex = decalInfo and materialInfo and materialInfo.tr and materialInfo.tr.Entity:EntIndex(),
		...
		newMaterial = materialInfo.newMaterial or MR.Materials:GetSelected(ply),
		newMaterial2 = materialInfo.newMaterial2,
...
function Data:CreateFromMaterial(oldMaterialIn, newMaterial, newMaterial2, isDecal, blockCleanup)
	...
	local data = {
		...
		detail = MR.Detail:Get(oldMaterialIn) or nil
	}
...
-- Set cvars based on the given data
function Data:ToCvars(ply, data)
